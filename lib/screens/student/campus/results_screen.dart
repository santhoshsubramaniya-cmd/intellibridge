  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        // FIX: No orderBy — we sort by semester client-side
        stream: fs.getResultsForStudent(email),
        builder: (context, snapshot) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Your faculty will post results here',
                      style: TextStyle(
                          color: AppColors.lightMuted, fontSize: 13)),
                  const SizedBox(height: 8),
                  Text('Registered as: $email',
                      style: const TextStyle(
          ...
          // Sort client-side by semester
          final docs = snapshot.data!.docs.toList()
            ..sort((a, b) {
              final as_ = (a.data() as Map)['semester'] as int? ?? 0;
              final bs = (b.data() as Map)['semester'] as int? ?? 0;
          ...
          for (var doc in docs) {
            ...
            bySemester.putIfAbsent(result.semester, () => []).add(result);
          }

          final allResults = docs
              .map((d) => ResultModel.fromMap(
                  ...
                  return Column(
                    ...
                    children: [
                      Row(children: [
                        ...
                        Text('Avg: ${semAvg.toStringAsFixed(0)}%',
                            style: const TextStyle(
                                fontSize: 12,
