  ...
  Future<void> _login() async {
    ...
    if (result == AuthResult.success) {
      ...
      switch (auth.userModel?.role) {
        case 'faculty': home = const FacultyHome(); break;
        case 'admin': home = const AdminHome(); break;
        case 'recruiter': home = const RecruiterHome(); break;
        default: home = const StudentHome();
      }
            ...
            child: Column(
              ...
              children: [
                ...
                Row(children: [
                  ...
                  const Text('InteliBridge', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
                ...
                const Text('Log in to your campus-to-career platform',
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  const Text("Don't have an account? ", style: TextStyle(color: AppColors.lightMuted)),
                  GestureDetector(
